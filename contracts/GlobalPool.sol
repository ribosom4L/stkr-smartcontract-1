...
contract MicroPool is OwnableUpgradeSafe, Lockable {
    ...
    */
    ...
    /**
        Frozen stakes of ETH pool providers
    */
    mapping (address => uint256) private _frozenStakes;

    /**
        Claimed rewards of stakers
    */
    ...
    /**
        Pool slashings
    */
    mapping (address => uint256) private _poolSlashings;
    ...
    */
    ...
    /**
        Provider pending pools
    */
    mapping(address => bool) private hasPendingPool; // provider -> bool
