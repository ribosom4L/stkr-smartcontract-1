...
contract AETH_R5 is OwnableUpgradeSafe, ERC20UpgradeSafe, Lockable {
    ...
    function updateRatio(uint256 newRatio) public onlyOperator {
        ...
        require(newRatio < _ratio.add(threshold), "New ratio cannot be greater than threshold");
        require(newRatio > _ratio.sub(threshold), "New ratio cannot be lower than threshold");
        _ratio = newRatio;
